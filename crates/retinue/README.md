...
a library. Live-interoperable with RNS 1.4.2.
...
against the current RNS 1.4.2 pin:
...
- **Interface access codes** — network-name/passphrase identity derivation,
  ...
  sans-I/O codec. A pinned RNS 1.4.2 gate passes in both directions.
...
- **Link-less asymmetric packets** — outbound encryption selects the current
  ...
  RNS 1.4.2 in both crypto directions.
