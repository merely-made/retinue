...
receipts passed; display-off wake observation open; U2 next (2026-07-28)
...
DISPLAY OFF and its consumed wake press remain controller-tested but have not
yet been observed physically. See
...
- fitted-display detection/BSP facts are recorded
...
Begin U2 by confirming whether the connected T114 has its optional TFT fitted.
The V4 DISPLAY OFF wake observation remains a small U1 follow-up. The host
snapshot command and Retinue pages remain U3 work.
