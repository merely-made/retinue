...
| O3 (observations) | Partial physical: T114 RX/TX, cursor loss, identical reads, pressured-session recovery and 12/12 captures under concurrent unread-host load; power-cut history reset verified; refusal and cost measurements remain open | [Radio observation plan](2026-09-06_radio_observation_plan.md#2026-09-08-physical-result) · [Raw receipt](2026-09-08_t114_observation_receipt.json) · [Concurrent receipt](2026-09-08_t114_observation_pressure_receipt.json) |
