...
| O5 (observations) | Durable capture landed in `ca32e0e` with 20 focused tests. Desktop view/settings integration is in progress; its automated and headed acceptance remain open. | [Radio observation plan](2026-09-06_radio_observation_plan.md#o5-availability-view-and-export) |
