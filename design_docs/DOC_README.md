...
| [Murmuration controller plan](2026-09-10_murmuration_controller_plan.md) | MC0–MC3e receipts; MC4a embedded cores, capacity controls and Xtensa/host memory evidence implemented. Resident runtime, target memory qualification and fault injection remain open. |
