...
| O3 (observations) | Partial physical: T114 RX/TX, cursor loss, identical reads and pressured-session recovery verified; refusal, power-cycle and cost measurements remain open | [Radio observation plan](2026-09-06_radio_observation_plan.md#2026-09-08-physical-result) · [Raw receipt](2026-09-08_t114_observation_receipt.json) |
