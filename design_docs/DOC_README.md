...
| [Murmuration controller plan](2026-09-10_murmuration_controller_plan.md) | MC0–MC3e bounded slices passed, including explicit session loss and V4 board-timed PHY return. Resident firmware protocol adapters and fault injection remain open. |
